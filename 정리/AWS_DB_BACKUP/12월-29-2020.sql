...
SET DEFINE OFF;
Insert into ADMIN.BOARD (TITLE,CONTENT,USER_ID,B_DATE,BOARD_NO,CATEGORY) values ('식당문의(재수정)','학원근처식당 추가되었네요 고생하셨어요','user',to_date('2020/12/24','RRRR/MM/DD'),1,'식당문의');
Insert into ADMIN.BOARD (TITLE,CONTENT,USER_ID,B_DATE,BOARD_NO,CATEGORY) values ('건의드립니다.','버그가 너무많아요','user2',to_date('2020/12/24','RRRR/MM/DD'),2,'건의사항');
Insert into ADMIN.BOARD (TITLE,CONTENT,USER_ID,B_DATE,BOARD_NO,CATEGORY) values ('필독!','다 추가하기 너무 힘들어요','admin',to_date('2020/12/24','RRRR/MM/DD'),3,'공지사항');
Insert into ADMIN.BOARD (TITLE,CONTENT,USER_ID,B_DATE,BOARD_NO,CATEGORY) values ('건의','버그테스트2','user3',to_date('2020/12/28','RRRR/MM/DD'),4,'건의사항');
Insert into ADMIN.BOARD (TITLE,CONTENT,USER_ID,B_DATE,BOARD_NO,CATEGORY) values ('건의1','페이징','user2',to_date('2020/12/28','RRRR/MM/DD'),5,'건의사항');
...
Insert into ADMIN.REVIEW (RES_ID,USER_ID,R_CONTENT,GRADE,RE_NO,RE_DATE) values (4,'user','싸이버거 안먹어봤으면 말걸지 마세요',5,15,to_date('2020/12/28','RRRR/MM/DD'));
...
Insert into ADMIN.USER_PICK (RES_ID,USER_ID) values (2,'guest');
...
SET DEFINE OFF;
Insert into ADMIN.USERS (USER_ID,NICKNAME,PASSWORD,NAME,MONEY,PHONE) values ('user','유저','1234','김유저',0,'01011111111');
...
Insert into ADMIN.USERS (USER_ID,NICKNAME,PASSWORD,NAME,MONEY,PHONE) values ('user3','유저3','1234','정유저',0,'01022222222');
